...
import org.training.spark.loganalysis.cassandra.dao.LogEventDAO
import org.training.spark.loganalysis.utils.{AccessLogUtils, ApacheAccessLog}
...
object LogAnalyzerKafkaStreaming {
  ...
  val BATCH_INTERVAL = new Duration(10 * 1000)
